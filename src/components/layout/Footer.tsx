          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-primary-foreground/70 text-sm leading-relaxed mb-6">
                Breaking barriers in communication through innovative assistive
                technology. Empowering connections for everyone.
              </p>
            ...
            >
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3 text-sm group">
                  ...
                  <span className="text-primary-foreground/70 group-hover:text-primary-foreground transition-colors">
                    Powerhouse Chorangi,North <br />
                    karachi, Pakistan 71500
                  </span>
                </li>
              </ul>
            </motion.div>
