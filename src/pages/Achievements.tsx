...
const milestones = [
  {
    ...
    description:
      "HandsOn Communicator was founded with a mission to break communication barriers through innovative technology.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Developed our first working prototype demonstrating real-time sign language recognition capabilities.",
    status: "completed",
  ...
  },
  {
    ...
    title: "Beta Testing",
    description:
      "Launched beta testing with 500+ users from the deaf community, gathering valuable feedback.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Selected for a prestigious tech incubator, receiving mentorship and funding to accelerate development.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Official product launch with improved AI accuracy and expanded language support.",
    status: "completed",
  ...
  },
  {
    ...
    description:
      "Expanding to international markets with support for multiple sign language variants.",
    status: "in-progress",
...
const Achievements = () => {
  return (
    <Layout>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 z-10">
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${milestone.color} flex items-center justify-center shadow-xl hover:scale-110 transition-transform group`}
                  >
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <div className="relative bg-card rounded-3xl p-6 md:p-8 shadow-card hover:shadow-elevated transition-all border border-border group-hover:border-primary/30 group-hover:-translate-y-2 text-center h-full">
                  <div
                    className={`w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br ${achievement.color} flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all`}
                  >
      ...
      {/* Stats Section */}
      <section className="relative py-16 md:py-20 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 dark:from-gray-100 dark:via-gray-50 dark:to-gray-100 text-white dark:text-gray-900 overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 dark:text-gray-600 max-w-2xl mx-auto">
